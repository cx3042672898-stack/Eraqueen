...
function renderManor(){
  ...
  list.innerHTML=acquired.map(function(c){
    ...
    var avaHtml;
    if(profile.avaImg){
      avaHtml='<div style="width:52px;height:52px;background:var(--card2);border-radius:50%;overflow:hidden;cursor:pointer;flex-shrink:0" onclick="openSlaveAvaModal('+cid+')" title="更换头像"><img src="'+profile.avaImg+'" style="width:100%;height:100%;object-fit:cover"></div>';
    }else{
